// The modal/pop-up to be shown as you click "Nova Entrada"
...
interface IncomeCreationModalProps {
    onClose: () => void;
}

export default function IncomeCreationModal({ onClose }: IncomeCreationModalProps) {
    ...
    const { mutate, isPending, error } = useCreateIncome();
